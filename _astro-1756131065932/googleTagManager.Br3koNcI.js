import { an as c, ao as m } from "./siteModulesConstants.C35rp0Wk.js";
const $ = (e) => {
    const t = `${e}=`,
  ...
  u = (e) => e.startsWith("www."),
  I = (e) => (u(e) ? e.substring(4) : e),
  ...
  T = ({ containerId: e, googleAdsIds: t }) => {
    const n = t.length
  ...
  l = ({ siteMeta: e, areCookiesAllowed: t }) => {
    ...
    return (
      ...
      t &&
        ...
        (n["script-fb-pixel"] = {
          tagName: "script",
          children: [{ type: "text", value: f(e.facebookPixel) }],
        }),
      t &&
      ...
      t &&
        ...
        e.googleAnalytics &&
          (n["script-google-analytics-async"] = {
            tagName: "script",
            properties: { src: j(e.googleAnalytics) },
          })),
      t &&
        e.hotjar &&
        (n["script-hotjar"] = {
          tagName: "script",
          children: [{ type: "text", value: b(e.hotjar) }],
        }),
      Object.entries(n).map(
        ([a, { tagName: o, properties: s = {}, children: r = [] }]) => ({
          type: "element",
          tagName: o,
          properties: { ...s, [c]: a },
          children: r,
  ...
  d = (e) => {
    e.forEach((t) => (m.includes(t.properties[c]) ? h(t) : p(t)));
  },
  S = ({ siteMeta: e, areCookiesAllowed: t }) => {
  ...
  P = (e) => {
    const t = e.reduce((o, s) => {
      ...
      n = e.map((o) => ({ title: o.title, slug: o.seo_settings.slug })),
      { currency: a } = e[0].variants[0].prices[0];
    return { value: t, currency: a.code.toUpperCase(), items: n };
  };
export {
  I as a,
  S as b,
